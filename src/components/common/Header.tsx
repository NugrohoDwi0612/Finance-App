...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-stone-50/90 dark:bg-stone-950/95 backdrop-blur-3xl border-b border-stone-200/80 dark:border-stone-800/80 px-3.5 py-2.5 pt-[max(0.75rem,env(safe-area-inset-top))] transition-colors duration-300">
