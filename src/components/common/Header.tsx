...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/85 dark:bg-stone-950/85 backdrop-blur-2xl border-b border-stone-200/60 dark:border-stone-800/80 px-3.5 py-2.5 transition-colors duration-200 pt-[max(0.75rem,env(safe-area-inset-top))]">
